...
func TestInitialize(t *testing.T) {
	...
	cfg.JeedomConfig.AutoCreateObjects = false
	cfg.ServerConfig.GMHostPort = "localhost:8081"
	...
	cfgDefault.JeedomConfig.AutoCreateObjects = false
	cfgDefault.ServerConfig.GMHostPort = "localhost:8081"
	tests := []struct {
		name     string
		confFile string
		wantErr  bool
